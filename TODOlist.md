...
| 7 | **摄像头通路验证 + draw_results 优化 + 实时播放（合集）** | **已完成（待用户确认上传）** | 2026-08-16 | 7.1 摄像头 YUYV 720p 通路 10.8 FPS；7.2 draw_results 3.4~3.8x 微基准提升、post -63%/-96%；7.3 --display 实时播放（视频/相机 FPS 差 <1%）；单测 29/29 |
